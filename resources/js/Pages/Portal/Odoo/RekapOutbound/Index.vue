  ...
  <AppLayout>
    <div class="p-4 md:p-6">
      <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 class="text-2xl font-bold">Portal Odoo - Rekap Outbound</h2>
          <p class="text-sm text-slate-400">
            Menampilkan ringkasan outbound stock dari t_move_history (Delivery Orders, Repack Outbound, Return Receipts).
          </p>
        </div>
