<template>
  <AppLayout>
    <div class="p-4 md:p-6">
      <h2 class="mb-4 text-2xl font-bold">Add Area Absensi</h2>
      ...
      <div class="max-w-2xl rounded bg-slate-800 p-4 md:p-6">
        <form @submit.prevent="submit">
          ...
          <div class="flex flex-col-reverse gap-2 sm:flex-row">
            <button type="submit" class="rounded bg-indigo-600 px-4 py-2 text-white">Save</button>
...
function submit() {
  router.post('/master-data/attendance-lock-area', form);
}
</script>
