...
export const fireSafetyLocationOptionsByType = {
    ...
    smoke_detector: [
        ...
        { id: "lantai_3_server", name: "Lantai 3 - R. Server" },
        { id: "lantai_3_makan", name: "Lantai 3 - R. Makan" },
        { id: "lantai_3_staff", name: "Lantai 3 - Staff" },
        { id: "lantai_3_meeting", name: "Lantai 3 - R. Meeting" },
    ],
    apar: [
        { id: "lantai_1_penghangat_powder_6kg_001", name: "Lantai 1 - R. Penghangat - Powder 6 Kg 001" },
        { id: "lantai_1_admin_powder_3kg_001", name: "Lantai 1 - R. Admin - Powder 3 Kg 001" },
        { id: "lantai_1_loading_dock_powder_6kg_002", name: "Lantai 1 - R. Loading Dock - Powder 6 Kg 002" },
        { id: "lantai_1_loading_dock_powder_6kg_003", name: "Lantai 1 - R. Loading Dock - Powder 6 Kg 003" },
        { id: "lantai_1_anteroom_powder_6kg_001", name: "Lantai 1 - R. Anteroom - Powder 6 Kg 001" },
        { id: "lantai_1_batrai_co2_5kg_001", name: "Lantai 1 - R. Batrai - CO2 5 Kg 001" },
        { id: "lantai_1_mesin_co2_5kg_002", name: "Lantai 1 - R. Mesin - CO2 5 Kg 002" },
        { id: "lantai_1_travo_pln_belakang_co2_5kg_001", name: "Lantai 1 - Travo PLN Belakang - CO2 5 Kg 001" },
        { id: "lantai_1_travo_pln_depan_co2_9kg_002", name: "Lantai 1 - Travo PLN Depan - CO2 9 Kg 002" },
        { id: "lantai_2_pantry_powder_6kg_005", name: "Lantai 2 - Pantry - Powder 6 Kg 005" },
        { id: "lantai_3_server_co2_5kg_003", name: "Lantai 3 - R. Server - CO2 5 Kg 003" },
        { id: "lantai_3_makan_powder_6kg_006", name: "Lantai 3 - R. Makan - Powder 6 Kg 006" },
    ],
};
