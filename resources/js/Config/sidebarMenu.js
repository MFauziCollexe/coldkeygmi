                ...
                children: [
                    {
                        ...
                        label: "Stock Card",
                        icon: "Package",
                        route: "/portal/odoo/stock-card",
                        module_key: "portal.odoo.stock_card",
                    },
                    {
                        id: "portal-odoo-soh",
                        label: "SOH",
                        icon: "Boxes",
                        route: "/portal/odoo/soh",
                        module_key: "portal.odoo.soh",
                    },
                    {
                        id: "portal-odoo-rekap-inbound",
                        label: "Rekap Inbound",
                        icon: "Download",
                        route: "/portal/odoo/rekap-inbound",
                        module_key: "portal.odoo.rekap_inbound",
                    },
                    {
                        id: "portal-odoo-rekap-outbound",
                        label: "Rekap Outbound",
                        icon: "Upload",
                        route: "/portal/odoo/rekap-outbound",
                        module_key: "portal.odoo.rekap_outbound",
                    },
                ],
            },
        ],
